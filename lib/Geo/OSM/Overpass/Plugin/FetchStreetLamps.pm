package Geo::OSM::Overpass::Plugin::FetchStreetLamps;
...
Geo::OSM::Overpass::Plugin::FetchStreetLamps - Plugin for L<Geo::OSM::Overpass> to fetch bus stop data in given area
...
data about street lamps within a geographical area defined by a bounding
...
Please report any bugs or feature requests to C<bug-geo-osm-overpass-plugin-FetchStreetLamps at rt.cpan.org>, or through
the web interface at L<https://rt.cpan.org/NoAuth/ReportBug.html?Queue=Geo-OSM-Overpass-Plugin-FetchStreetLamps>.  I will be notified, and then you'll
...
L<https://rt.cpan.org/NoAuth/Bugs.html?Dist=Geo-OSM-Overpass-Plugin-FetchStreetLamps>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Geo-OSM-Overpass-Plugin-FetchStreetLamps>

=item * CPAN Ratings

L<https://cpanratings.perl.org/d/Geo-OSM-Overpass-Plugin-FetchStreetLamps>

=item * Search CPAN

L<https://metacpan.org/release/Geo-OSM-Overpass-Plugin-FetchStreetLamps>
...
=cut
1; # End of Geo::OSM::Overpass::Plugin::FetchStreetLamps
